<?php
include_once($_SERVER['DOCUMENT_ROOT'] . '/moduloVentas/panelEmitirFactura.php');
...
$panelEmitirFacturaObject = new panelEmitirFactura();
$panelEmitirFacturaObject->panelEmitirFacturaShow($productos);
