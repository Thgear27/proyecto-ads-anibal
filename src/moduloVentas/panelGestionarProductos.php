        ...
        <div style="display: flex;">
            ...
            <main style="padding: 0 2rem;">
                ...
                <form method="post" action="../moduloVentas/getProducto.php">
                    <button type="submit" name="btnAgregarProducto">Agregar producto</button>
                </form>
                            ...
                            <?php if ($productos !== null) : ?>
                                ...
                                <?php foreach ($productos as $producto) : ?>
                                    <tr>
                                        ...
                                        <form method="post" action="../moduloVentas/getProducto.php">
                                            <td>
                                                <button type="submit" name="btnEditarProducto">
                                                    Editar
                                                </button>
                                            </td>
                                            <td>
                                                <button type="submit" name="btnEliminarProducto">
                                                    Eliminar
                                                </button>
                                            </td>
                                        </form>
